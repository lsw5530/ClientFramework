...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new LuaFramework.BaseLuaUIForm.delLuaStart(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaFramework.BaseLuaUIForm.delLuaAwake))
			{
			    return new LuaFramework.BaseLuaUIForm.delLuaAwake(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaFramework.BaseLuaUIForm.delLuaUpdate))
			{
			    return new LuaFramework.BaseLuaUIForm.delLuaUpdate(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaFramework.BaseLuaUIForm.delLuaDestroy))
			{
			    return new LuaFramework.BaseLuaUIForm.delLuaDestroy(__Gen_Delegate_Imp0);
			}
